FROM ubuntu:16.04
MAINTAINER Victor Biga <victor.biga@gmail.com>
...
RUN chmod +x /usr/local/bin/start_nagios        && \
    ...
    chmod +x fix-nagiosgraph-multiple-selection.sh

RUN sh fix-nagiosgraph-multiple-selection.sh

RUN rm fix-nagiosgraph-multiple-selection.sh
